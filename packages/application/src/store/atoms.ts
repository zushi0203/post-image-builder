...
// 出力設定（ローカルストレージに保存）
export const outputSettingsAtom = atomWithStorage<OutputSettings>(
  "outputSettings",
  {
    format: "png",
    width: 1920,
...
// アニメーション制御アクション
export const toggleAnimationAtom = atom(null, (get, set) => {
...
export const setAnimationLoopAtom = atom(null, (get, set, loop: boolean) => {
  const settings = get(animationSettingsAtom);
