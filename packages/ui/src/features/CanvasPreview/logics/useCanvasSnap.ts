...
export const useCanvasSnap = (
  ...
  const snapPoints = useMemo((): SnapPoint[] => {
    ...
    return [
      ...
      {
        id: "top-right",
        name: "Output Top Right",
        x: outputRight,
        y: outputTop,
      },
      {
        id: "bottom-left",
        name: "Output Bottom Left",
        x: outputLeft,
        y: outputBottom,
      },
      {
        id: "bottom-right",
        name: "Output Bottom Right",
        x: outputRight,
        y: outputBottom,
      },
      // 出力領域の4つの辺の中点
      {
        id: "top-center",
        name: "Output Top Center",
        x: outputCenterX,
        y: outputTop,
      },
      {
        id: "bottom-center",
        name: "Output Bottom Center",
        x: outputCenterX,
        y: outputBottom,
      },
      {
        id: "left-center",
        name: "Output Left Center",
        x: outputLeft,
        y: outputCenterY,
      },
      {
        id: "right-center",
        name: "Output Right Center",
        x: outputRight,
        y: outputCenterY,
      },
    ];
  ...
  const calculateDistance = useCallback(
    (point1: CanvasCoordinates, point2: CanvasCoordinates): number => {
  ...
  const findNearestSnapPoint = useCallback(
    (position: CanvasCoordinates, layer?: ImageLayer): SnapResult => {
      ...
      for (const mapping of snapMappings) {
        ...
        const layerAnchorPos = layerBounds[
          mapping.layerAnchor
  ...
  const getSnapPointById = useCallback(
    (id: string): SnapPoint | undefined => {
